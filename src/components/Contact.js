...
const Contact = () => {
    ...
    const createMessage = async () => {
        ...
        //CLEANING INPUT NUMBER PHONE FILELD
        setPhoneNumber('+1')
        ...
        const resetDataValues = Object.keys(data).map(key => {
            data[key] = ''
        })
        ...
        <div className="bg-black min-h-screen h-full w-full">
            ...
            <div className="bg-black relative top-28 md:top-20 flex flex-col justify-center items-center">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-0 md:gap-4 justify-center w-[85%]">
                    ...
                    <form onSubmit={onSubmit} className=" flex flex-col gap-1 text-white text-[15px] font-semibold py-6 px-10 md:px-4 lg:px-10">
...
name="phone"
value={phone}
placeholder="Enter a code area + phone number"
onChange={onChange}
>
</input>
*/